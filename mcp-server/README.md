...
| `search_activities(query?, tags?, free_only?, limit?, category?, source?)` | Evergreen things to do (separate store). Default-off (`AI411_EVERGREEN_SEARCH_ENABLED`). Not dated; do not treat as open now |
