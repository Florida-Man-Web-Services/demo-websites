/**
 * Apex Worker for sarahgjrealtor.com — reverse-proxy the IMPACTO demo at the
 * stable floridamanweb vanity path. Host header to origin is floridamanweb.online
 * so the existing Cilium Gateway listener matches (Free-plan Origin Rules cannot
 * override Host).
 */
const HOP = new Set([
  "host",
...
export default {
  async fetch(request, env) {
    ...
    out.set("x-fmws-vanity", "sarah-gj-realtor");
